...
export STATE_BUCKET_KEY="key=bitbucket-pipelines/$BITBUCKET_PROJECT_KEY/$BITBUCKET_REPO_SLUG/apply-destroy/$BITBUCKET_REPO_SLUG-$BITBUCKET_BUILD_NUMBER.tfstate"
